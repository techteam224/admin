                ...
                <li class="nav-header">
                    <div class="dropdown profile-element"> 
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"> {{ $userDetails->name }}</strong>
                             </span> <span class="text-muted text-xs block">{{ $userDetails->role }} <b class="caret"></b></span> </span> </a>
